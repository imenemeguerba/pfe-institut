...
<div class="form-inner">
    ...
    <form method="POST" action="{{ route('admin.categories-produits.store') }}">
        @csrf
        <div class="form-card">
            ...
            <div class="f-group">
                ...
                <input type="text" name="nom" value="{{ old('nom') }}" required autofocus
                       class="f-input" placeholder="e.g. Moisturizers, Serums...">
                @error('nom')<p class="f-error">{{ $message }}</p>@enderror
            </div>
            <div class="f-group">
                <label class="f-label">Description</label>
                <textarea name="description" class="f-input" placeholder="Brief description...">{{ old('description') }}</textarea>
