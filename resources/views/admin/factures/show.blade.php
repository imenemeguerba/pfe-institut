...
.show-top h1 { font-family:'Playfair Display',serif; font-size:18px; font-weight:800; color:#1a1a2e; }
...
.fi-value a { color:#b480ff; text-decoration:none; }
.fi-value a:hover { color:#9333ea; }
...
.download-bar { display:flex; gap:10px; margin-top:4px; }
...
<div class="show-inner">
    ...
    <div class="show-top">
        ...
        <a href="{{ route('admin.factures.index') }}" class="btn-back">
    ...
    <div class="fac-card">
        ...
        <div class="info-grid">
            <div>
                ...
                <div class="fi-value">
                    <a href="{{ route('admin.clients.show', $facture->client) }}">{{ $facture->client->fullName() }}</a>
                </div>
            </div>
            <div>
                <div class="fi-label">VAT Rate</div>
                <div class="fi-value">{{ number_format($facture->taux_tva, 0) }}%</div>
            </div>
        </div>
    </div>
    ...
    @if($facture->estDeCommande() && $facture->commande)
        <div class="fac-card">
            <div class="fac-card-title"><i class="fa-solid fa-cart-shopping"></i> Order Details — {{ $facture->commande->numero }}</div>
    ...
    <div class="download-bar">
        <a href="{{ route('admin.factures.telecharger', $facture) }}" class="btn-pdf">
