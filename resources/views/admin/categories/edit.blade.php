...
<div class="form-inner">
    <div class="form-top">
        <h1>Edit Category — {{ $category->nom }}</h1>
    ...
    <form method="POST" action="{{ route('admin.categories.update', $category) }}" enctype="multipart/form-data">
        ...
        <div class="form-card">
            ...
            <div class="f-group">
                ...
                <input type="text" name="nom" value="{{ old('nom', $category->nom) }}" required autofocus class="f-input">
                @error('nom')<p class="f-error">{{ $message }}</p>@enderror
            </div>
            <div class="f-group">
                <label class="f-label">Description</label>
                <textarea name="description" class="f-input">{{ old('description', $category->description) }}</textarea>
                ...
                <div class="img-upload-area">
                    ...
                    <label class="img-drop" for="imageInput">
                        ...
                        <div class="img-drop-text">
                            <h4 id="imgLabel">{{ $category->image ? 'Replace image' : 'Click to upload' }}</h4>
