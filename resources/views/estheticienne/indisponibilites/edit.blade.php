<x-app-layout>
<x-slot name="header">Edit Absence</x-slot>
...
<div class="cr-hero">
    ...
    <div class="cr-hero-content">
        <div>
            <div class="cr-hero-tag"><i class="fa-solid fa-pen"></i> Edit</div>
            <div class="cr-hero-title">Edit <span>Absence</span></div>
        </div>
...
<div class="form-body"><div class="form-inner">
    <form method="POST" action="{{ route('estheticienne.indisponibilites.update', $indisponibilite) }}">
        @csrf @method('PATCH')
        <div class="form-card">
                    ...
                    @foreach(['conge'=>['🏖️','Vacation'],'maladie'=>['🤒','Sick Leave'],'formation'=>['🎓','Training'],'autre'=>['📌','Other']] as $val=>$info)
                        <div>
                            <input type="radio" name="type" id="type_{{ $val }}" value="{{ $val }}"
                                   class="type-opt" {{ old('type',$indisponibilite->type)===$val?'checked':'' }}>
            ...
            <div class="f-row">
                <div class="f-group" style="margin-bottom:0;">
                    ...
                    <input type="date" name="date_debut_jour" required class="f-input"
                           value="{{ old('date_debut_jour',$indisponibilite->date_debut->format('Y-m-d')) }}">
                ...
                <div class="f-group" style="margin-bottom:0;">
                    ...
                    <input type="date" name="date_fin_jour" required class="f-input"
                           value="{{ old('date_fin_jour',$indisponibilite->date_fin->format('Y-m-d')) }}">
            ...
            <div class="f-group" style="margin-top:16px;margin-bottom:0;">
                ...
                <textarea name="motif" class="f-input" rows="3" maxlength="500">{{ old('motif',$indisponibilite->motif) }}</textarea>
            </div>
        </div>
