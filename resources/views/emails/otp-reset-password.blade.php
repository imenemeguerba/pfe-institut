...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p class="msg">We received a request to reset your password for your <strong>Glow Institute</strong> account. Use the verification code below to proceed.</p>
        <div class="card" style="text-align:center;padding:28px 24px;">
            <p style="font-size:12px;color:#64748b;margin-bottom:12px;text-transform:uppercase;letter-spacing:1px;font-weight:600;">Your verification code</p>
            <div style="font-size:40px;font-weight:800;letter-spacing:10px;color:#b480ff;font-family:monospace;">{{ $otp }}</div>
            <p style="font-size:11px;color:#94a3b8;margin-top:14px;">This code expires in <strong style="color:#1e293b;">15 minutes</strong></p>
        </div>
        <div class="warning"><strong>⚠️ Security notice:</strong> If you did not request a password reset, please ignore this email. Your account remains secure.</div>
        <div class="divider"></div>
        <p style="font-size:12px;color:#94a3b8;text-align:center;">For security, never share this code with anyone.<br><strong style="color:#b480ff;">Glow Institute</strong> will never ask for your code.</p>
    </div>
    <div class="footer">
