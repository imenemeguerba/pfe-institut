...
<div class="wrapper">
    <div class="header">
        ...
        <p>Information about your expert account</p>
    </div>
    <div class="body">
        <p class="greeting">Hello, <strong>{{ $prenom }}</strong></p>
        @if($action === "supprime")
        <p class="msg">Your expert account at <strong>Glow Institute</strong> has been <strong style="color:#dc2626;">permanently deleted</strong>.</p>
        <div class="card red">
            @if($motif)<p style="font-size:13px;color:#991b1b;">Reason: {{ $motif }}</p>@endif
            <p style="font-size:13px;color:#991b1b;margin-top:6px;">All your data has been removed from our system.</p>
        </div>
        @elseif($action === "desactive")
        <p class="msg">Your expert account at <strong>Glow Institute</strong> has been <strong style="color:#d97706;">temporarily deactivated</strong>.</p>
        <div class="card orange">
            @if($motif)<p style="font-size:13px;color:#92400e;">Reason: {{ $motif }}</p>@endif
            <p style="font-size:13px;color:#92400e;margin-top:6px;">You will not be able to receive appointments during this period.</p>
        </div>
        @else
        <p class="msg">Great news! Your expert account at <strong>Glow Institute</strong> has been <strong style="color:#059669;">reactivated</strong>.</p>
        <div class="card green"><p style="font-size:13px;color:#065f46;">You can now log in and start receiving appointments again.</p></div>
        @endif
