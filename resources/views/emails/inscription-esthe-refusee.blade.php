...
<div class="wrapper">
    <div class="header">
        ...
        <p>Response to your application</p>
    </div>
    <div class="body">
        <p class="greeting">Hello, <strong>{{ $prenom }}</strong></p>
        <p class="msg">We have carefully reviewed your application to join <strong>Glow Institute</strong> as a beauty expert.<br>Unfortunately, we are unable to proceed with your application at this time.</p>
        <div class="card red">
            @if($motif)
            <div class="card-row"><span class="card-label">Reason</span><span class="card-value" style="color:#991b1b;">{{ $motif }}</span></div>
            @else
            <p style="font-size:13px;color:#991b1b;">Your profile does not currently meet our required criteria.</p>
            @endif
        </div>
        <p class="msg" style="margin-top:16px;">We encourage you to apply again in the future. Thank you for your interest in Glow Institute.</p>
    </div>
    <div class="footer">
