...
<div class="wrapper">
    ...
    <div class="body">
        ...
        @if($action === "supprime")
        <p class="msg">We inform you that your <strong>Glow Institute</strong> account has been <strong style="color:#dc2626;">permanently deleted</strong>.</p>
        <div class="card red">
            <p style="font-size:13px;color:#991b1b;">All your data has been removed from our system in accordance with your request.</p>
            @if($motif)<p style="font-size:13px;color:#991b1b;margin-top:8px;">Reason: {{ $motif }}</p>@endif
        </div>
        @else
        <p class="msg">We inform you that your <strong>Glow Institute</strong> account has been <strong style="color:#d97706;">temporarily suspended</strong>.</p>
        <div class="card orange">
            @if($motif)<p style="font-size:13px;color:#92400e;">Reason: {{ $motif }}</p>@endif
            <p style="font-size:13px;color:#92400e;margin-top:6px;">To contest this decision, please contact our team.</p>
        </div>
        @endif
        <p class="msg" style="margin-top:16px;">If you believe this is a mistake, please contact the Glow Institute administration.</p>
    </div>
    <div class="footer">
